package frc.robot.utils;//LimelightHelpers v1.2.1 (March 1, 2023)
...
public class VisionUtils {
    ...
    public static class LimelightTarget_Fiducial {
        ...
        // made this into a double arr cause frc.robot.subsystems.VisionSubsystem expects it this way
        // could be troublesome

        public double[] getRobotPose_TargetSpaceDouble() {
     ...
     */
    public static LimelightResults getLatestResults(ObjectMapper mapper, String limelightName) {

        long start = System.nanoTime();
        VisionUtils.LimelightResults results = new VisionUtils.LimelightResults();
        if (VisionUtils.mapper == null) {
            VisionUtils.mapper = new ObjectMapper().configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
        }

        try {
            results = VisionUtils.mapper.readValue(getJSONDump(limelightName), LimelightResults.class);
